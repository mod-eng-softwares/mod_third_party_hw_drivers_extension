...
- 1x [PH 2 Click](https://www.mikroe.com/ph-2-click)
- 1x [Plastic pH electrode BNC connector](https://www.mikroe.com/plastic-ph-electrode-bnc-connector)

## Hardware Connection ##

The Silicon Labs Explorer Kit boards feature a mikroBUS™ socket, allowing the PH 2 Click board to connect easily via the mikroBUS header. Ensure that the 45-degree corner of the PH 2 Click board aligns with the 45-degree white line on the Explorer Kit. The hardware connection is illustrated in the image below.
...
| Description | BRD4314A | BRD4108A | BRD2703A | BRD2710A | ↔ | PH 2 Click |
| --- | --- | --- | --- | --- | --- | --- |
| I2C_SDA | PD3 | PD3 | PB5 | PD3 | ↔ | SDA |
| I2C_SCL | PD2 | PD2 | PB4 | PD2 | ↔ | SCL |
| Status Signal 1  | PC6 | PC6 | PC8 | PC6 | ↔ | ST1 |
| Status Signal 2  | PB3 | PB3 | PB1 | PB3 | ↔ | ST2 |
| Thermometer Data | PB4 | PB4 | PA0 | PB4 | ↔ | DQ  |

**Silicon Labs Wi-Fi Development Kit:**

| Description | BRD4338A + BRD4002A | BRD2605A | BRD2708A | ↔ | PH 2 Click |
| --- | --- | --- | --- | --- | --- |
| I2C_SDA | ULP_GPIO_6 [EXP_16] | ULP_GPIO_6 [P16] | GPIO_6 | ↔ | SDA |
| I2C_SCL | ULP_GPIO_7 [EXP_15] | ULP_GPIO_7 [P15] | GPIO_7 | ↔ | SCL |
| Status Signal 1  | GPIO_46 [P24] | GPIO_10 [P23] | GPIO_30          | ↔ | ST1 |
| Status Signal 2  | GPIO_47 [P26] | GPIO_11 [P22] | UULP_VBAT_GPIO_2 | ↔ | ST2 |
| Thermometer Data | GPIO_48 [P28] | GPIO_12 [P25] | GPIO_12          | ↔ | DQ  |
