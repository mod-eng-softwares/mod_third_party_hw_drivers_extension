...
// $[GPIO_ACCEL8_DA]
#define ACCEL8_DA_PORT                   SL_GPIO_PORT_B
#define ACCEL8_DA_PIN                    0
// [GPIO_ACCEL8_DA]$

// <gpio optional=true> ACCEL8_CL
// $[GPIO_ACCEL8_CL]
#define ACCEL8_CL_PORT                   SL_GPIO_PORT_C
#define ACCEL8_CL_PIN                    6
// [GPIO_ACCEL8_CL]$

// <gpio optional=true> ACCEL8_INT
// $[GPIO_ACCEL8_INT]
#define ACCEL8_INT_PORT                  SL_GPIO_PORT_B
#define ACCEL8_INT_PIN                   3
// [GPIO_ACCEL8_INT]$
