...
// $[GPIO_BRUSHLESS16_RD]
#define BRUSHLESS16_RD_PORT                   UULP_VBAT
#define BRUSHLESS16_RD_PIN                    2
// [GPIO_BRUSHLESS16_RD]$

// <gpio optional=true> BRUSHLESS16_FG
// $[GPIO_BRUSHLESS16_FG]
#define BRUSHLESS16_FG_PORT                   HP
#define BRUSHLESS16_FG_PIN                    12
// [GPIO_BRUSHLESS16_FG]$

// <gpio optional=true> BRUSHLESS16_EN
// $[GPIO_BRUSHLESS16_EN]
#define BRUSHLESS16_EN_PORT                   HP
#define BRUSHLESS16_EN_PIN                    28
// [GPIO_BRUSHLESS16_EN]$
