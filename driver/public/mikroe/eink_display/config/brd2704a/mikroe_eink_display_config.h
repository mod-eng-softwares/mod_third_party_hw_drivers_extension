...
#define EINK_DISPLAY_DC_PORT                        SL_GPIO_PORT_D
#define EINK_DISPLAY_DC_PIN                         0
// [GPIO_EINK_DISPLAY_DC]$

// <gpio optional=true> EINK_DISPLAY_RST
// $[GPIO_EINK_DISPLAY_RST]
#define EINK_DISPLAY_RST_PORT                       SL_GPIO_PORT_D
#define EINK_DISPLAY_RST_PIN                        1
// [GPIO_EINK_DISPLAY_RST]$

// <gpio optional=true> EINK_DISPLAY_BSY
// $[GPIO_EINK_DISPLAY_BSY]
#define EINK_DISPLAY_BSY_PORT                       SL_GPIO_PORT_D
#define EINK_DISPLAY_BSY_PIN                        2
// [GPIO_EINK_DISPLAY_BSY]$
